/**
 * ใบงานเสริม: การตั้งค่า Wi-Fi ผ่านหน้าเว็บ Web Configuration (โค้ดเริ่มสำหรับนักเรียน)
 * ให้นักเรียนเติมคำสั่งในช่องว่างที่มีเครื่องหมาย /* เติมคำสั่งที่นี่ */ ให้สมบูรณ์
 */
...
void saveWifiConfig(String ssid, String pass) {
  // ========================================================
  // ช่องว่างที่ 2: ให้นักเรียนเปิดไฟล์ตั้งค่าเขียนข้อมูลลง JSON
  // ========================================================
  File file = /* เติมคำสั่งเปิดไฟล์เขียนข้อมูลที่นี่ */;
...
void loop() {
  ...
  if (apMode) {
    // ========================================================
    // ช่องว่างที่ 1: ให้นักเรียนเติมคำสั่งเพื่อให้ DNS ทำการรันและคอย Redirect
    // ========================================================
    /* เติมคำสั่งประมวลผล DNS ที่นี่ */;

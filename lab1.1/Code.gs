/**
 * Web App for Lab 1.1: Switch Input (Digital Input & Debounce)
  ...
  try {
    ...
    if (!sheet) {
      ...
      var headers = [
        ...
        "โค้ดโจทย์ท้าทาย (Challenge Code)", "คำอธิบายตรรกะ (controlLogic)",
        "คำตอบ Code ช่องที่ 1", "คำตอบ Code ช่องที่ 2", "คำตอบ Code ช่องที่ 3", "คำตอบ Code ช่องที่ 4", "คำตอบ Code ช่องที่ 5",
        "คำถามข้อที่ 1 (Internal Pullup vs External Pulldown)", "คำถามข้อที่ 2 (Switch Bouncing & Debounce)",

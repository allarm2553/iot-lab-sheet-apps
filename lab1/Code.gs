...
function doGet(e) {
  return HtmlService.createTemplateFromFile('index')
    .evaluate()
    .setTitle('ใบงานที่ 1: การอ่านค่าเซ็นเซอร์และการควบคุมเอาต์พุต')
...
function submitLabData(data) {
  try {
    ...
    var sheetName = "Lab 1 Submissions";
    ...
    var folderName = "Lab 1 Attachments";
    ...
    return {
      status: "success",
      message: "บันทึกข้อมูลใบงานที่ 1 สำเร็จแล้ว! คะแนนประเมินอัตโนมัติ: " + grading.score + "/10.0 คะแนน\n\nรายละเอียดคะแนน:\n" + grading.feedback
    };

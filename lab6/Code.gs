/**
 * Web App for Lab 6: Advanced Hybrid Node Integration
...
function doGet(e) {
  return HtmlService.createTemplateFromFile('index')
    .evaluate()
    .setTitle('ใบงานที่ 6: การบูรณาการโครงงาน Hybrid Node ขั้นสูง (Grand Challenge)')
...
function submitLabData(data) {
  try {
    ...
    var sheetName = "Lab 6 Submissions";
    ...
    if (!sheet) {
      ...
      var headers = [
        ...
        "คำถามข้อที่ 1 (Non-blocking MQTT)", "คำถามข้อที่ 2 (LAN-First industrial)",
    ...
    var folderName = "Lab 6 Attachments";
    ...
    return {
      status: "success",
      message: "บันทึกข้อมูลใบงานที่ 6 สำเร็จแล้ว! คะแนนประเมินอัตโนมัติ: " + grading.score + "/10.0 คะแนน\n\nรายละเอียดคะแนน:\n" + grading.feedback
    };

/**
 * Web App for Lab 7: การเชื่อมโยงข้อมูลและการสร้างแดชบอร์ดด้วย Node-RED
...
function doGet(e) {
  return HtmlService.createTemplateFromFile('index')
    .evaluate()
    .setTitle('ใบงานที่ 7: การเชื่อมโยงข้อมูลและการสร้างแดชบอร์ดด้วย Node-RED')
    .addMetaTag('viewport', 'width=device-width, initial-scale=1')
    .setXFrameOptionsMode(HtmlService.XFrameOptionsMode.ALLOWALL);
}

// Auto-grading logic for Lab 7
// Auto-grading logic for lab7
// Auto-grading logic for lab7
function gradeSubmission(data) {
  var blankKeywords = ["json","payload","msg","change","switch"];
  var challengeKeywords = ["payload", "humidity", "20", "Alert: Dry Climate!|dry|alert"];
  var q1Keywords = ["string","object","แปลง","json","สตริง","JavaScript"];
  var q2Keywords = ["เปลี่ยน","ON","OFF","payload","ค่า","แปลง","กำหนด"];
...
function submitLabData(data) {
  try {
    ...
    var sheetName = "Lab 7 Submissions";
    ...
    if (!sheet) {
      ...
      var headers = [
        ...
        "คำตอบท้าทาย (JS Function Node)", 
        "คำถามข้อที่ 1 (โหนด JSON)", "คำถามข้อที่ 2 (โหนด Change & Switch)",
    ...
    var folderName = "Lab 7 Attachments";
    ...
    return {
      status: "success",
      message: "บันทึกข้อมูลใบงานที่ 7 สำเร็จแล้ว! คะแนนประเมินอัตโนมัติ: " + grading.score + "/10.0 คะแนน\n\nรายละเอียดคะแนน:\n" + grading.feedback
    };
